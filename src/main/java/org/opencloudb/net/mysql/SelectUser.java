...
public class SelectUser {
	...
	private static byte[] getUser(FrontSession session) {
		StringBuilder sb = new StringBuilder();
		ConnectionInfo conInfo = session.getConInfo();
		sb.append(conInfo.getUser()).append('@').append(conInfo.getHost());
		return StringUtil.encode(sb.toString(), conInfo.getCharset());
	}

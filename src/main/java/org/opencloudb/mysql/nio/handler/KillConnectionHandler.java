...
import org.opencloudb.net.mysql.BackMysqlConnection;
...
public class KillConnectionHandler implements ResponseHandler {
	...
	private final BackMysqlConnection killee;
	private final FrontSession session;

	public KillConnectionHandler(BackendConnection killee,
			FrontSession session) {
		this.killee = (BackMysqlConnection) killee;
		this.session = session;
	}

	@Override
	public void connectionAcquired(BackendConnection conn) {
		BackMysqlConnection mysqlCon = (BackMysqlConnection) conn;
